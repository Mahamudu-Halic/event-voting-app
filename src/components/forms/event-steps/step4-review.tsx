    ...
    <Card className="bg-purple-surface border-purple-accent/50">
      <CardHeader>
        ...
        <CardDescription className="text-text-secondary">
          Please review all the details before creating your event. You can edit
          any section by clicking the edit button.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {/* Step 1: Basic Info */}
        <ReviewSection onEditStep={onEditStep} step={1} title="Basic Information" icon={Calendar}>
          <div className="space-y-3 p-4 rounded-lg bg-purple-bg/50 border border-purple-accent/20">
            <div>
              ...
              <p className="text-text-primary font-medium">
                {formData.eventName || "Not provided"}
              </p>
            </div>
            <div>
              <span className="text-xs text-text-secondary uppercase tracking-wider">
              ...
              <p className="text-text-primary text-sm leading-relaxed">
                {formData.eventDescription || "Not provided"}
              </p>
            </div>
            {formData.eventImage && (
              <div>
        ...
        {/* Step 2: Event Tools */}
        <ReviewSection onEditStep={onEditStep} step={2} title="Event Tools" icon={Settings}>
          <div className="flex flex-wrap gap-3">
            <Badge
              variant={formData.enableNominations ? "default" : "outline"}
              className={
                formData.enableNominations
        ...
        {/* Step 3: Pricing */}
        <ReviewSection onEditStep={onEditStep} step={3} title="Pricing" icon={Coins}>
          <div className="space-y-3 p-4 rounded-lg bg-purple-bg/50 border border-purple-accent/20">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-error">
                -₵{fees.serviceFeeAmount.toFixed(2)}
              </span>
            </div>
