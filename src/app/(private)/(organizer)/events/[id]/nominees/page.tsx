              ...
              <div className="flex items-center gap-3">
                ...
                <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                  ...
                  <SelectContent className="bg-violet-950/95 backdrop-blur-xl border-violet-500/30 rounded-xl">
                    <SelectItem value="all" className="text-white/90 focus:bg-violet-500/20 focus:text-white rounded-lg mx-1 my-0.5">
                      All Categories
                    </SelectItem>
                    {categories.map((cat) => (
                      <SelectItem
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-white/10 hover:bg-transparent">
                  <TableHead className="text-white/60 font-medium">Photo</TableHead>
                  <TableHead className="text-white/60 font-medium">Full Name</TableHead>
                  <TableHead className="text-white/60 font-medium">Category</TableHead>
                  <TableHead className="text-white/60 font-medium">Unique Code</TableHead>
                  <TableHead className="text-white/60 font-medium">Votes</TableHead>
        ...
        <DialogContent className="bg-linear-to-br from-violet-950 to-purple-900 border-violet-500/30 rounded-2xl">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <DialogTitle className="text-xl font-bold text-white">Delete Nominee</DialogTitle>
            </div>
            <DialogDescription className="text-purple-200/70 text-base">
              Are you sure you want to delete <span className="text-white font-medium">&quot;{deletingNominee?.nominee_name}&quot;</span>?
